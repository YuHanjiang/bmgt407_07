...
;(function () {
    ...
    ;DayPilot.Date = function ($04, $05) {
        ...
        if (Object.defineProperty && !DayPilot.browser.ielt9) {
            ...
            Object.defineProperty(this, "value", {"value": $08, "writable": false, "enumerable": true});
        } else {
            this.ticks = $U;
            this.value = $08;
        }
...
(function () {
    ...
    function str($x, $1f) {
        var i, k, v, length, $1g = $1b, $1h, $08 = $1f[$x];
...
;(function () {
    ...
    DayPilotCalendar.Calendar = function (id) {
        ...
        this.events.load = function ($13, $14, $15) {
            ...
            if ($1b) {
                DayPilot.Http.ajax({
                    "method": "POST",
                    "data": {"start": $b.visibleStart().toString(), "end": $b.visibleEnd().toString()},
                    "url": $13,
                    "success": $18,
                    "error": $16
                });
                ...
                ;DayPilot.Http.ajax({"method": "GET", "url": $1c, "success": $18, "error": $16});
            }
        };
    ...
    ;(function registerAngularModule() {
        ...
        ;$1M.directive("daypilotCalendar", ['$parse', function ($1N) {
            return {
                "restrict": "E", "template": "<div></div>", "replace": true, "link": function ($1O, element, $1P) {
...
;(function () {
    ...
    DayPilot.Modal = function ($k) {
        ...
        this.$0u = function (e) {
            ...
            $l.$0d = {x: $l.div.offsetLeft, y: $l.div.offsetTop};
        };
        this.$0s = function (e) {
            if (!$l.$0e) {
                return;
...
;(function () {
    ...
    DayPilotMonth.Month = function ($b) {
        ...
        this.events.load = function ($k, $l, $m) {
            ...
            if ($t) {
                DayPilot.Http.ajax({
                    "method": "POST",
                    "data": {"start": $c.visibleStart().toString(), "end": $c.visibleEnd().toString()},
                    "url": $k,
                    "success": $q,
                    "error": $n
                });
                ...
                ;DayPilot.Http.ajax({"method": "GET", "url": $u, "success": $q, "error": $n});
            }
        };
        this.update = function () {
            if (!this.cells) {
    ...
    ;(function registerAngularModule() {
        ...
        ;$11.directive("daypilotMonth", ['$parse', function ($12) {
            return {
                "restrict": "E", "template": "<div></div>", "replace": true, "link": function ($13, element, $14) {
...
;(function () {
    ...
    ;(function registerAngularModule() {
        ...
        ;$W.directive("daypilotNavigator", function () {
            return {
                "restrict": "E", "template": "<div id='{{id}};'></div>", "compile": function compile(element, $X) {
